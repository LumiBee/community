...
public interface ArticleMapper extends BaseMapper<Article> {
        ...
        @Select("SELECT article_id, title, slug, excerpt, view_count, likes, a.gmt_modified, a.user_id, u.name AS userName, u.avatar_url "
                        + // 按需选择字段
                        "FROM articles a " +
        ...
        @Select("SELECT count(*) from articles where user_id = #{id} and deleted = 0 and status = 'published'")
